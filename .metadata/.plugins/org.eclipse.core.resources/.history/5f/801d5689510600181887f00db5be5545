...
<body id="home">
		...
		<div class="row">
			<div id="aboutus">
				...
				<p align="center">Silvertax is an American multinational
					conglomerate corporation incorporated in New York and head quartered
					in Boston, Massachusetts. As of 2016, the company operates through
					the following segments: Aviation, Current, Digital, Energy
					Connections, Global Research, Healthcare, Lighting, Oil and Gas,
					Power, Renewable Energy, Transportation, and Capital which cater to
					the needs of Financial services, Medical devices, Life Sciences,
	...
	<div id="footer">
		<footer>
			<p align="center">&copy; Silver Tax 2018, All Rights
				Reserved</p>
		</footer>
	</div>
